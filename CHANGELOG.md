...
- Recover 90/180/270-degree PaddleOCR page orientation with bounded crop probes and confidence checks, using existing
  ...
  the published source page and clean up private images on success or exception. Retain crop rotation metadata
  to distinguish readable sideways lines from an upright page; the existing disable switch covers all directions.
