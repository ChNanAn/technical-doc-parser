...
class PdfDocumentBackend final
    : public pipeline::IDocumentSource,
...
public:
    ...
    bool renderPages(const pipeline::PipelineContext& context, std::vector<document::PageArtifact>& pages) const override;
