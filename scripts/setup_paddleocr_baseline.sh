...
PADDLEOCR_DET_REVISION=${PADDLEOCR_DET_REVISION}
PADDLEOCR_REC_REVISION=${PADDLEOCR_REC_REVISION}
PADDLEOCR_DICT_REVISION=${PADDLEOCR_DICT_REVISION}
...
det_revision=${PADDLEOCR_DET_REVISION}
rec_revision=${PADDLEOCR_REC_REVISION}
dict_revision=${PADDLEOCR_DICT_REVISION}
